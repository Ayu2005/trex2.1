...
function setup() {
 ...
 console.log(message)
  ...
  invisibleGround = createSprite(windowWidth/2,windowHeight/2+10,windowWidth,10);
  ...
  sun=createSprite(windowWidth-20,20);
...
function draw() {
  ...
  if(gameState === PLAY){
    ...
    if((touches.length>0||keyDown("space"))&& trex.y+20>= windowHeight/2) {
        trex.velocityY = -12;
        jumpSound.play();
        touches=[];
    }
